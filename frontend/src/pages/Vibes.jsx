...
const Vibes = () => {
  ...
  return (
    <div className="h-dvh bg-bg text-text-primary overflow-hidden relative sm:ml-[72px] lg:ml-[240px]">
      {/* Header */}
      ...
      {/* Vibes Content */}
      <div className="h-full w-full overflow-y-auto snap-y snap-mandatory scrollbar-hide flex justify-center">
        {" "}
        {loading ? (
